                                ...
                                <ModalBody>
                                    <div className="flex justify-between items-center mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                                            📝 ลงทะเบียนเข้าใช้งานศูนย์เพื่อนใจ
                                        </h3>
                                    </div>                
                                    ...
                                    <Input endContent={
                                        ...
                                        type={isVisible ? "text" : "password"} onInput={handleChange} value={data.password} label='รหัสผ่าน' name="password" fullWidth placeholder="•••••" />
                                </ModalBody>
                                <ModalFooter>
                                {
                                isClicked === false && 
